...
func Home(events []shared.Event, meetNearMeTestSecret string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"header-hero\"><h1 class=\"text-2xl md:text-5xl text-center pt-5\">Magically <span class=\"font-system\">&#x2728</span> collect in-person events you care about <span class=\"font-system\">&#x1F938</span> and discover new ones</h1><h2 class=\"text-lg md:text-2xl font-mono font-light text-center bg-base-100\">Meet Near Me is a place to gather all of the in-person local events scattered across the internet into one unified place, volunteer to raise local event awareness, and discover nearby events shared by others.</h2></div><br><br><h2 class=\"text-3xl\">Events</h2><div class=\"border rounded-lg overflow-hidden divide-y dark:divide-gray-800\"><table class=\"w-full divide-y divide-gray-200 dark:divide-gray-900\"><tr class=\"grid w-full grid-cols-5 items-stretch bg-gray-100 dark:bg-gray-800\"><th class=\"flex w-full items-center justify-center p-4\">Name</th><th class=\"flex w-full items-center justify-center p-4\">Date</th><th class=\"flex w-full items-center justify-center p-4\">Time</th><th class=\"flex w-full items-center justify-center p-4\">Location</th><th class=\"flex w-full items-center justify-center p-4\"></th></tr><tbody>")
			...
			for _, ev := range events {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 52, Col: 137}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 53, Col: 100}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 54, Col: 100}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 55, Col: 87}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 69, Col: 24}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `functions/lambda/views/home.templ`, Line: 70, Col: 52}
			}
