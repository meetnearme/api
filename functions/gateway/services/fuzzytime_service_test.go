	...
	withFrozenTime(t, func() {
		tests := []struct {
			...
			// Additional dateparse examples that should work
			{
				...
				expected: "2009-05-08T17:57:51",
				hasError: false,
			},
			{
				name:     "abbreviated_month_date",
				input:    "oct 7, 1970",
				expected: "1970-10-07T00:00:00",
				hasError: false,
			},
			{
			...
			},
			{
				...
				input:    "3.31.2014",
				expected: "2014-03-31T00:00:00",
				hasError: false,
			},
			{
				name:     "compact_date_time",
				input:    "20140722105203",
				expected: "2014-07-22T10:52:03",
				hasError: false,
			},
			{
				name:     "mysql_log_format",
				input:    "171113 14:14:20",
				expected: "2017-11-13T14:14:20",
				hasError: false,
			},
			...
			},
			{
				...
				expected: "2024-07-25T15:00:00", // Timezone ignored: literal time as UTC
				hasError: false,
			},
			{
				name:     "with_iana_timezone",
				input:    "2024-07-25 3:00 PM America/New_York",
				expected: "2024-07-25T15:00:00", // fuzzytime fallback handles IANA timezones
				hasError: false,
			},
			...
			// Facebook formats
			{
				...
				expected: "2099-10-03T09:00:00", // timezone ignored: literal clock time treated as UTC
				hasError: false,
			},
			{
				name:     "facebook_format_without_year",
				input:    "Fri, 10 Oct at 09:00 CDT",
				expected: "2025-10-10T09:00:00", // timezone ignored: literal clock time treated as UTC
				hasError: false,
			},
			{
				name:     "facebook_format_24hr_time",
				input:    "Fri, 12 Sep at 17:00 CDT",
				expected: "2025-09-12T17:00:00", // timezone ignored: literal clock time treated as UTC
				hasError: false,
			},
			{
				name:     "facebook_format_24hr_time_with_range",
				input:    "Thursday 12 September 2024 from 17:00-21:00 CDT",
				expected: "2024-09-12T17:00:00", // fuzzytime + addNextFutureYear + timezone ignored (literal time as UTC)
				hasError: false,
			},
			{
				name:     "facebook_format_with_range",
				input:    "Saturday, September 14, 2024 at 2:00 PM – 4:00 PM CDT",
				expected: "2024-09-14T14:00:00", // fuzzytime + addNextFutureYear + timezone ignored (literal time as UTC)
				hasError: false,
			},
			{
			...
			// Production failure pattern - time range with timezone
			{
				...
				expected: "2099-09-12T17:00:00", // fuzzytime handles time range + timezone, returns without seconds
				hasError: false,
			},
			{
				name:     "production_time_range_with_timezone_past",
				input:    "Friday, September 12, 2024 at 5:00 PM – 9:00 PM CDT",
				expected: "2024-09-12T17:00:00", // fuzzytime handles time range + timezone, returns without seconds
				hasError: false,
			},
			// Test cases to ensure both dateparse and fuzzytime paths ignore timezones
			{
				...
				expected: "2024-07-25T15:00:00",       // dateparse + timezone ignored (literal time as UTC)
				hasError: false,
			},
			{
