...
CREATE TABLE IF NOT EXISTS seshujobs (
    ...
    target_child_name_css_path TEXT,
    target_child_location_css_path TEXT,
    target_child_start_time_css_path TEXT,
    target_child_end_time_css_path TEXT,
    target_child_description_css_path TEXT,
